...
Display all available agent skills.
...
| `/patch [filename] [instructions]` | Edit an existing file with automatic backup |
...
| Skill | Description |
|-------|------------|
| `/status [class or all]` | Show module completion table |
